...
"""
pagina ='http://news.ycombinator.com/'
pag_2 = 'https://hacker-news.firebaseio.com/v0/item/9884165.json'

pega = requests.get(pag_2)

print(pega)#Acessou cod 200
print("Status Codigo: ", pega.status_code)
